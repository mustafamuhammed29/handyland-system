...
const DEFAULT_HANDYLAND_PHRASES_AR = [
...
const DEFAULT_HANDYLAND_PHRASES_DE = [
...
export const AdminPanel = ({
  ...
  const defaultMascotList = lang === 'ar' ? DEFAULT_HANDYLAND_PHRASES_AR : DEFAULT_HANDYLAND_PHRASES_DE;
                  ...
                  <div className="bg-gray-800/80 p-5 rounded-2xl border border-gray-700 space-y-4">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        placeholder={lang === 'ar' ? 'اكتب جملة جديدة هنا (مثال: أهلاً بكم في عروضنا! 🚀)' : 'Neue Phrase eingeben (z.B. Willkommen zu unseren Angeboten! 🚀)'}
